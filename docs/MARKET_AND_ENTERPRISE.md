...
not audit anyone's encryption claims): zero-knowledge encryption in the browser, a format built for decades, dead-man's-switch and progressive release, white-label B2B at 50,000 capsules, and a
...
|---|---|---|
| Family / individual | Private by construction; opens on the date you choose; still readable in 5, 10, 20 years | Encryption, triggers, versioned format |
